...
- [Introducción a los datos](./entries/intro_datos.md)
- [Primer lenguaje](./entries/intro_primerlang.md)
...
En esta sección se invita a estudiar la teoría e intentar entender sus algoritmos y su estructura.
...
**Derechos de autor**
La mayoría de los recursos son links a los sitios oficiales, por lo que todos son extraidos de internet e indexados por google, esta guia no promueve la piratería ni el fraude.

Todos los textos que no son recursos ni tienen citas a fuentes extenas, son escritos por [Esteban Gonzalez](https://estebandev.xyz) `esteban@estebandev.xyz`.
